...
describe "IPTables Policy/One-offs" do
  context iptables do
    it { should have_rule('-m conntrack --ctstate RELATED,ESTABLISHED -j ACCEPT').with_table('filter') }
    it { should have_rule('-P INPUT DROP').with_table('filter') }
